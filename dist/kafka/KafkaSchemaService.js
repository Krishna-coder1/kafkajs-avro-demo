...
exports.KafkaSchemaService = void 0;
var confluent_schema_registry_1 = require("@kafkajs/confluent-schema-registry");
var KafkaSchemaService = /** @class */ (function () {
    function KafkaSchemaService(registry, topic, schemaPath) {
        this.registry = registry;
        this.topic = topic;
        this.schemaPath = schemaPath;
    }
    KafkaSchemaService.prototype.register = function () {
    ...
    KafkaSchemaService.prototype.encode = function (schemaId, message) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.registry.encode(schemaId, message)];
            });
        });
    };
    return KafkaSchemaService;
}());
exports.KafkaSchemaService = KafkaSchemaService;
