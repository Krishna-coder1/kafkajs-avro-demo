...
exports.KafkaAdminService = void 0;
var KafkaAdminService = /** @class */ (function () {
    function KafkaAdminService(admin, topic) {
        this.admin = admin;
        this.topic = topic;
    }
    KafkaAdminService.prototype.ensureTopicExists = function () {
...
exports.KafkaAdminService = KafkaAdminService;
